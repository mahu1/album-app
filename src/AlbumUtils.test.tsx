...
describe('calculateTotalLengthOfTracks', () => {
  it('calculates the total length of tracks', () => {
    ...
    const firstTrack: ITrack = { "trackNumber": 1, "title": "Lion's Mane", "seconds": 169, "album": album, "id": 161 }
    const secondTrack: ITrack = { "trackNumber": 2, "title": "Bird Stealing Bread", "seconds": 261, "album":album, "id": 162 }
    const thirdTrack: ITrack = { "trackNumber": 3,  "title": "Faded from the Winter", "seconds": 197, "album": album, "id": 163 }
